  ...
  class LocationsControllerTest < ActionDispatch::IntegrationTest
    ...
    test 'should create fifty_location' do
      assert_difference('Fifty::Location.count') do
        post fifty_locations_url,
             params: { fifty_location: { country: @fifty_location.country, state: @fifty_location.state } }, as: :json
      end
    ...
    test 'should update fifty_location' do
      patch fifty_location_url(@fifty_location),
            params: { fifty_location: { country: @fifty_location.country, state: @fifty_location.state } }, as: :json
      assert_response :success
    end
