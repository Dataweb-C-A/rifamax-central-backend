...
class Fifty::StadiaControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create fifty_stadium" do
    assert_difference("Fifty::Stadium.count") do
      post fifty_stadia_url, params: { fifty_stadium: { location_id: @fifty_stadium.location_id, name: @fifty_stadium.name } }, as: :json
    end
  ...
  test "should update fifty_stadium" do
    patch fifty_stadium_url(@fifty_stadium), params: { fifty_stadium: { location_id: @fifty_stadium.location_id, name: @fifty_stadium.name } }, as: :json
    assert_response :success
  end
