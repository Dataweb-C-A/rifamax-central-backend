  ...
  class ClientsControllerTest < ActionDispatch::IntegrationTest
    ...
    test 'should create x100_client' do
      assert_difference('X100::Client.count') do
        post x100_clients_url,
             params: { x100_client: { dni: @x100_client.dni, email: @x100_client.email, name: @x100_client.name, phone: @x100_client.phone } }, as: :json
      end
    ...
    test 'should update x100_client' do
      patch x100_client_url(@x100_client),
            params: { x100_client: { dni: @x100_client.dni, email: @x100_client.email, name: @x100_client.name, phone: @x100_client.phone } }, as: :json
      assert_response :success
    end
